                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/store') }}" method="post">
                            ...
                            <div class="form-group">
                                <label>Reg No</label>
                                <input name="regno" type="text" class="form-control"  placeholder="Enter Reg No">
                            </div>
                            <div class="form-group">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/update/'.$student->id) }}" method="post">
                            ...
                            <div class="form-group">
                                <label>Reg No</label>
                                <input value="{{ $student->regno }}" name="regno" type="text" class="form-control"  placeholder="Enter Reg No">
                            </div>
                            <div class="form-group">
                                <label>First Name</label>
                                <input value="{{ $student->first_name }}" name="first_name" type="text" class="form-control"  placeholder="Enter the first name">
                            </div>
                            <div class="form-group">
                                <label>last Name</label>
                            ...
                            <div class="form-group">
                                <label>Father Name</label>
                                <input value="{{ $student->father_name }}" name="father_name" type="text" class="form-control"  placeholder="Enter Father name">
                            </div>
                            <div class="form-group">
                                <label>Age</label>
